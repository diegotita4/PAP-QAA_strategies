...
class BacktestingDinamico:
    ...
    def run_backtesting(self):
        ...
        estrategia.cargar_datos()
        estrategia.optimizar()
        
        precios_actuales = estrategia.datos.iloc[-1]
        pesos_optimos = estrategia.pesos_optimos
        
        valor_inversion_por_ticker = valor_portafolio * pesos_optimos
        ...
        fila_resultado = {
            ...
            **{f'peso_{ticker}': pesos_optimos[i] for i, ticker in enumerate(self.tickers)},
