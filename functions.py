...
class QAA:
    ...
    def load_data(self):
        ...
        tickers_with_benchmark = self.tickers + [self.benchmark_ticker] if (self.benchmark_ticker not
                                                                            in self.tickers) else self.tickers
...
# ----------------------------------------------------------------------------------------------------
   ...
   # ---------------------------------------------------------------------------------------------------- 
    ...
    # 11TH QAA STRATEGY: "Black Litterman"
    ...
    # 12TH QAA STRATEGY: "Total Return AA"
